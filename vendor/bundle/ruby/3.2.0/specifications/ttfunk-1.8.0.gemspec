...
Gem::Specification.new do |s|
  ...
  s.email = ["[email removed]".freeze, "[email removed]".freeze, "[email removed]".freeze, "[email removed]".freeze, "[email removed]".freeze, "[email removed]".freeze, "[email removed]".freeze]
