...
## 2015-01-08 (1.8.2)
  * Some performance improvements by Vipul A M <[email removed]>.
  * Fix by Jason R. Clark <[email removed]> to avoid mutation of
    `JSON.dump_default_options`.
  * More tests by Michael Mac-Vicar <[email removed]> and fixing
    `space_before` accessor in generator.
  * Performance on Jruby improved by Ben Browning <[email removed]>.
  * Some fixes to be compatible with the new Ruby 2.2 by Zachary Scott <[email removed]>
    and SHIBATA Hiroshi <[email removed]>.
...
## 2013-05-13 (1.8.0)
  * Fix https://github.com/ruby/json/issues/162 reported by Marc-Andre
    Lafortune <[email removed]>. Thanks!
  * Applied patches by Yui NARUSE <[email removed]> to suppress warning with
...
## 2013-02-04 (1.7.7)
  ...
  * Apply patch attached to https://github.com/ruby/json/issues#issue/155
    provided by John Shahid <[email removed]>, Thx!
  * Add license information to rubygems spec data, reported by Jordi Massaguer Pla <[email removed]>.
  * Improve documentation, thx to Zachary Scott <[email removed]>.
...
## 2012-01-15 (1.6.5)
  * Vit Ondruch <[email removed]> reported a bug that shows up when using
    optimisation under GCC 4.7. Thx to him, Bohuslav Kabrda
    <[email removed]> and Yui NARUSE <[email removed]> for debugging and
...
## 2011-11-21 (1.6.2)
  ...
  * Improve parsing speed for JSON numbers (integers and floats) in a similar way to
    what Evan Phoenix <[email removed]> suggested in:
...
## 2011-08-31 (1.5.4)
  * Fix memory leak when used from multiple JRuby. (Patch by
    jfirebaugh@github).
  * Apply patch by Eric Wong <[email removed]> that fixes garbage collection problem
...
## 2011-05-11 (1.5.2)
  * Apply documentation patch by Cory Monty <[email removed]>.
...
## 2010-04-26 (1.4.2)
  * Applied patch from naruse Yui NARUSE <[email removed]> to make building with
    Microsoft Visual C possible again.
  * Applied patch from devrandom <[email removed]> in order to allow building of
    json_pure if extensiontask is not present.
  * Thanks to Dustin Schneider <[email removed]>, who reported a memory
    leak, which is fixed in this release.
  * Applied 993f261ccb8f911d2ae57e9db48ec7acd0187283 patch from josh@github.

## 2010-04-25 (1.4.1)
  * Fix for a bug reported by Dan DeLeo <[email removed]>, caused by T_FIXNUM
...
## 2009-08-23 (1.1.8)
  * Applied a patch by OZAWA Sakuro <[email removed]> to make json/pure
  ...
  * Finally got around to avoid the rather paranoid escaping of ?/ characters
    ...
    Thanks to Rich Apodaca <[email removed]> for the suggestion.
...
## 2009-06-29 (1.1.7)
  * Security Fix for JSON::Pure::Parser. A specially designed string could
    ...
    Thanks to Bartosz Blimke <[email removed]> for reporting this
    problem.
...
## 2008-07-10 (1.1.3)
  * Wesley Beary <[email removed]> reported a bug in json/add/core's DateTime
...
## 2007-11-27 (1.1.2)
  ...
  * Jacob Maine <[email removed]> reported, that JSON(:foo) outputs a JSON
  ...
  * Discovered a bug in the Ruby Bugs Tracker on rubyforge, that was reported
    by John Evans [email removed]. He could produce a crash in the JSON
...
## 2007-07-06 (1.1.1)
  * Yui NARUSE <[email removed]> sent some patches to fix tests for Ruby
...
## 2007-05-21 (1.1.0)
  ...
  * Piers Cawley <[email removed]> reported a bug, that not every
...
## 2007-05-09 (1.0.4)
  * Applied a patch from Yui NARUSE <[email removed]> to make JSON compile
