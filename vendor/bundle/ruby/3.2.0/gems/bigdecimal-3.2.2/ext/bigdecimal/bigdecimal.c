 ...
 *
 * Copyright(C) 2002 by Shigeo Kobayashi([email removed])
 *
 */
 ...
 *
 * Maintained by mrkn <[email removed]> and ruby-core members.
 *
 * Documented by zzak <[email removed]>, mathew <[email removed]>, and
