...
user_table = table do |v|
  ...
  v << %w( TJ Holowaychuk [email removed] )
  v << %w( Bob Someone [email removed] )
  v << %w( Joe Whatever [email removed] )
end
puts user_table
...
user_table = table do
  ...
  add_row ['TJ',  'Holowaychuk', '[email removed]']
  add_row ['Bob', 'Someone',     '[email removed]']
  add_row ['Joe', 'Whatever',    '[email removed]']
  add_separator
